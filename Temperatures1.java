...
// the least, greatest and average temperatures - weekly
        ...
        double[] avgT = new double[nofWeeks + 1];
         // Assigning the first value of the respective weekly array to the variables
        for(int week=1;week<=nofWeeks;week++) {
            minT[week] = t[week][1];
            maxT[week] = t[week][1];
            sumT[week] = 0;
            for (int measurement = 1; measurement <= nofMeasurementsPerWeek; measurement++)
            {
                ...
                sumT[week] = sumT[week] + t[week][measurement];
                //accessing the current element and adding
            }
